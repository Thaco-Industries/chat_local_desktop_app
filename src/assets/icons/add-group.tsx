interface AddGroupIconProps {
  color?: string; // Thuộc tính 'color' là tùy chọn
}
export default function AddGroupIcon({ color = '#076EB8' }: AddGroupIconProps) {
  return (
    <svg
      width="24"
      height="24"
      ...
      <g id="vuesax/linear/people">
        <g id="people">
          ...
          <g id="Group_2">
            <path
              id="Vector_3"
              d="M5.96949 7.16C6.02949 7.15 6.09949 7.15 6.15949 7.16C7.53949 7.11 8.63949 5.98 8.63949 4.58C8.63949 3.15 7.48949 2 6.05949 2C4.62949 2 3.47949 3.16 3.47949 4.58C3.48949 5.98 4.58949 7.11 5.96949 7.16Z"
              stroke={color}
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
          ...
          <g id="Group_3">
            <path
              id="Vector_5"
              d="M11.9991 14.6297C11.9391 14.6197 11.8691 14.6197 11.8091 14.6297C10.4291 14.5797 9.3291 13.4497 9.3291 12.0497C9.3291 10.6197 10.4791 9.46973 11.9091 9.46973C13.3391 9.46973 14.4891 10.6297 14.4891 12.0497C14.4791 13.4497 13.3791 14.5897 11.9991 14.6297Z"
              stroke={color}
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
